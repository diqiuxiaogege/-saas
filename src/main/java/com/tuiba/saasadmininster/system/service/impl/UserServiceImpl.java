...
import com.tuiba.saasadmininster.common.authentication.ShiroRealm;
...
import com.tuiba.saasadmininster.common.utils.SortUtil;
import com.tuiba.saasadmininster.system.entity.User;
import com.tuiba.saasadmininster.system.entity.UserRole;
import com.tuiba.saasadmininster.system.mapper.UserMapper;
import com.tuiba.saasadmininster.system.service.IUserRoleService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void createUser(User user) {
        ...
        save(user);
        // 保存用户角色
        if(user.getRoleId() != null && user.getRoleId() != "" && !user.getRoleId().equals("")){
    ...
    public void updateUser(User user) {
        ...
        if (user.getRoleId() != null) {
            roles = user.getRoleId().split(StringPool.COMMA);
        }
        setUserRoles(user, roles);

        User currentUser = FebsUtil.getCurrentUser();
        if (currentUser.getRoleId().equals(currentUser.getRoleId())) {
